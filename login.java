...
public class login extends JFrame implements ActionListener{
    ...
    passwordfield.setBackground(new Color(222,49,99));
    add(passwordfield);
    ...
    b1.setBackground(new Color(222,49,99));
    ...
    b2.setBackground(new Color(222,49,99));
    b2.setForeground(Color.WHITE);
    b2.addActionListener(this);
    add(b2);

     setTitle("login screen");
        getContentPane().setBackground(new Color(248,131,121));
        setLayout(null);
        setSize(600,300);
        setLocation(400,270);
        setVisible(true);
